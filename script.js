document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showFormSuccess() {
      ...
      successEl.textContent = contactForm.dataset.successMessage || 'Thank you! Your message has been sent successfully.';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Sharon Steinbaum Strategy משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '53b40a06-0957-44ea-8732-9682683d07b4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '53b40a06-0957-44ea-8732-9682683d07b4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '53b40a06-0957-44ea-8732-9682683d07b4';
